...
editable_settings = {
    ...
    "GPT Model": "llama-3.1-8b-instant"
}
...
if 'pyaudio' in globals() and pyaudio is not None:
    ...
    FORMAT = 8  # Fallback for paInt16
    p = None
    print("Audio hardware bypassed. Proceeding to File Transcription...")
CHANNELS = 1
RATE = 16000
RECORD_SECONDS = 5
...
if pyaudio is not None:
    ...
    p = None  # Creating an instance of PyAudio
